		...
		<div class="row">
			<div class="col-md-4">
				<div class="team text-center">
					...
					<div class="title">
						<h4>Qudrat Nurfajar</h4>
						<h5 class="muted regular">Fitness Instructor</h5>
					</div>
					<button data-toggle="modal" data-target="#modal1" class="btn btn-blue-fill">
						View Profile
					</button>
				</div>
			</div>
			<div class="col-md-4">
				<div class="team text-center">
					...
					<a href="#" data-toggle="modal" data-target="#modal1" class="btn btn-blue-fill ripple">
						View Profile
					</a>
				</div>
			</div>
